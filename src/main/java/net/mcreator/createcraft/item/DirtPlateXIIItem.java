...
public class DirtPlateXIIItem extends CreatecraftModElements.ModElement {
	@ObjectHolder("createcraft:dirt_plate_xii")
	public static final Item block = null;
	public DirtPlateXIIItem(CreatecraftModElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("dirt_plate_xii");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A pink dirt plate."));
		}
	}
}
